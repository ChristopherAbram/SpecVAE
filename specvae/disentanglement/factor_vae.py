...
def compute_factor_vae(
    ...
    artifact_dir=None, batch_size=128,
    num_train=100, num_eval=100, num_variance_estimate=100):
    """
    ...
    global_variances = _compute_variances(ground_truth_data,
        representation_function, num_variance_estimate, random_state)
    ...
    training_votes = _generate_training_batch(ground_truth_data,
        representation_function, batch_size, num_train, 
    ...
    eval_votes = _generate_training_batch(ground_truth_data,
        representation_function, batch_size, num_eval, 
        random_state, global_variances, active_dims)
...
def _compute_variances(ground_truth_data,
    ...
    random_state, eval_batch_size=64):
    """
...
def _generate_training_sample(ground_truth_data, representation_function,
    batch_size, random_state, global_variances, active_dims):
    """
...
def _generate_training_batch(ground_truth_data, representation_function,
    batch_size, num_points, random_state, global_variances, active_dims):
    """
