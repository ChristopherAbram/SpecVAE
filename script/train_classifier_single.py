...
def main(argc, argv):
    ...
    parser = argparse.ArgumentParser(description='Train deep classification model with metabolomics data')
    ...
    parser.add_argument('--model-name', type=str, help='A name of model', default='clf')
    ...
    parser.add_argument('--target-column', type=str, help='Name of the target column', default='ionization_mode_id')
    ...
    parser.add_argument('--layer-config', type=str, help='Model parameter, layer configuration for deep classifier', default='[$indim, 15]')
    ...
    train_loader, valid_loader, test_loader, metadata, class_weights = dt.load_data_classification(
        ...
        input_columns, types, target_column, True, class_subset, preload=preload)
